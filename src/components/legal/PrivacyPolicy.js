...
const PrivacyPolicy = () => {
  ...
  return (
    <Container style={styles.container}>
      ...
      <Typography variant="h6" component="h4">Leyes que incorpora esta política de privacidad</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6" component="h4">Identidad del responsable del tratamiento de los datos personales</Typography>
      <Typography variant="body2">
        El responsable del tratamiento de los datos personales recogidos en Accuarium es: Natán Morote, con NIF: 50971986F (en adelante, Responsable del tratamiento). Sus datos de contacto son los siguientes:
      ...
      <Typography variant="body2">
        En cumplimiento de lo establecido en el RGPD y la LOPD-GDD, le informamos que los datos personales recabados por Accuarium, mediante los formularios extendidos en sus páginas quedarán incorporados y serán tratados en nuestro fichero con el fin de poder facilitar, agilizar y cumplir los compromisos establecidos entre Accuarium y el Usuario o el mantenimiento de la relación que se establezca en los formularios que este rellene, o para atender una solicitud o consulta del mismo. Asimismo, de conformidad con lo previsto en el RGPD y la LOPD-GDD, salvo que sea de aplicación la excepción prevista en el artículo 30.5 del RGPD, se mantiene un registro de actividades de tratamiento que especifica, según sus finalidades, las actividades de tratamiento llevadas a cabo y las demás circunstancias establecidas en el RGPD.
      </Typography>
      ...
      <Typography variant="body2">
        Las categorías de datos que se tratan en Accuarium son únicamente datos identificativos. En ningún caso, se tratan categorías especiales de datos personales en el sentido del artículo 9 del RGPD.
      </Typography>
      <br/>
      ...
      <Typography variant="body2">
        La base legal para el tratamiento de los datos personales es el consentimiento. Accuarium se compromete a recabar el consentimiento expreso y verificable del Usuario para el tratamiento de sus datos personales para uno o varios fines específicos.
        <br/>
      ...
      <Typography variant="body2">
        Los datos personales son recabados y gestionados por Accuarium con la finalidad de poder facilitar, agilizar y cumplir los compromisos establecidos entre el Sitio Web y el Usuario o el mantenimiento de la relación que se establezca en los formularios que este último rellene o para atender una solicitud o consulta.
        <br/>
        Igualmente, los datos podrán ser utilizados con una finalidad comercial de personalización, operativa y estadística, y actividades propias del objeto social de Accuarium, así como para la extracción, almacenamiento de datos y estudios de marketing para adecuar el Contenido ofertado al Usuario, así como mejorar la calidad, funcionamiento y navegación por el Sitio Web.
        <br/>
      ...
      <Typography variant="body2">
        ...
        <ul>
          <li>Dinahosting S.L. B-15805419 Rúa das Salvadas 41, baixo 15705 Santiago de Compostela (A Coruña)</li>
        </ul>
      ...
      <Typography variant="body2">
        ...
        <br/>
        Sin embargo, debido a que Accuarium no puede garantizar la inexpugnabilidad de internet ni la ausencia total de hackers u otros que accedan de modo fraudulento a los datos personales, el Responsable del tratamiento se compromete a comunicar al Usuario sin dilación indebida cuando ocurra una violación de la seguridad de los datos personales que sea probable que entrañe un alto riesgo para los derechos y libertades de las personas físicas. Siguiendo lo establecido en el artículo 4 del RGPD, se entiende por violación de la seguridad de los datos personales toda violación de la seguridad que ocasione la destrucción, pérdida o alteración accidental o ilícita de datos personales transmitidos, conservados o tratados de otra forma, o la comunicación o acceso no autorizados a dichos datos.
        <br/>
      ...
      <Typography variant="body2">
        El Usuario tiene sobre Accuarium y podrá, por tanto, ejercer frente al Responsable del tratamiento los siguientes derechos reconocidos en el RGPD y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales:
        <ul>
          <li>Derecho de acceso: Es el derecho del Usuario a obtener confirmación de si Accuarium está tratando o no sus datos personales y, en caso afirmativo, obtener información sobre sus datos concretos de carácter personal y del tratamiento que Accuarium haya realizado o realice, así como, entre otra, de la información disponible sobre el origen de dichos datos y los destinatarios de las comunicaciones realizadas o previstas de los mismos.</li>
        ...
        <br/>
        Dirección postal: Carrer de la Paloma 3 1-1, 08001, Barcelona
        <br/>
        Correo electrónico: hello@accuarium.com
      </Typography>
      <br/>
      ...
      <Typography variant="body2">
        El Sitio Web puede incluir hipervínculos o enlaces que permiten acceder a páginas web de terceros distintos de Accuarium, y que por tanto no son operados por Accuarium. Los titulares de dichos sitios web dispondrán de sus propias políticas de protección de datos, siendo ellos mismos, en cada caso, responsables de sus propios ficheros y de sus propias prácticas de privacidad.
      </Typography>
      <br/>
      ...
      <Typography variant="body2">
        ...
        <br/>
        Este documento de Política de Privacidad de un sitio web ha sido creado mediante el generador de plantilla de política de privacidad online el día 15/07/2022.
      </Typography>
    </Container>
  );
};
