  ...
  return (
    <Container style={styles.container}>
      ...
      <Typography variant="body2">
        ...
        <br/>
        A efectos de estas Condiciones se entiende que la actividad que Accuarium desarrolla a través del Sitio Web comprende:
        <br/>
        Planificación y estudio de la acuariofilia.
        <br/>
        Además de leer las presentes Condiciones, antes de acceder, navegar y/o usar esta página web, el Usuario ha de haber leído el Aviso Legal y las Condiciones Generales de Uso, incluyendo, la política de cookies, y la política de privacidad y de protección de datos de Accuarium. Al utilizar este Sitio Web o al hacer y/o solicitar la adquisición de un producto y/o servicio a través del mismo el Usuario consiente quedar vinculado por estas Condiciones y por todo lo anteriormente mencionado, por lo que si no está de acuerdo con todo ello, no debe usar este Sitio Web.
        <br/>
      ...
      <Typography variant="h6" component="h3">2. EL USUARIO</Typography>
      <Typography variant="body2">
        ...
        <br/>
        El Usuario podrá formalizar, a su elección, con Accuarium el contrato de compraventa de los productos y/o servicios deseados en cualquiera de los idiomas en los que las presentes Condiciones estén disponibles en este Sitio Web.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">3. PROCESO DE COMPRA O ADQUISICIÓN</Typography>
      <Typography variant="body2">
        Los Usuarios debidamente registrados pueden comprar en el Sitio Web por los medios y formas establecidos. Deberán seguir el procedimiento de compra y/o adquisición online de http://accuarium.com, durante el cual varios productos y/o servicios pueden ser seleccionados y añadidos al carrito, cesta o espacio final de compra y, finalmente, hacer clic en: ""
        <br/>
        ...
        <br/>
        Seguidamente, el Usuario recibirá un correo electrónico confirmando que Accuarium ha recibido su pedido o solicitud de compra y/o prestación del servicio, es decir, la confirmación del pedido. Y, en su caso, se le informará, igualmente, mediante correo electrónico cuando su compra esté siendo enviada.
        Una vez el procedimiento de compra ha concluido, el Usuario consiente que el Sitio Web genere una factura electrónica que se hará llegar al Usuario a través del correo electrónico. Asimismo, el Usuario puede, si así lo desea, obtener una copia de su factura en papel, solicitándolo a Accuarium utilizando los espacios de contacto del Sitio Web o a través de los datos de contacto facilitados más arriba.
        <br/>
      ...
      <Typography variant="body2">
        ...
        Accuarium utiliza todos los medios para garantizar la confidencialidad y la seguridad de los datos de pago transmitidos por el Usuario durante las transacciones a través del Sitio Web. Como tal, el Sitio Web utiliza un sistema de pago seguro SSL (Secure Socket Layer).
        <br/>
        Las tarjetas de crédito estarán sujetas a comprobaciones y autorizaciones por parte de la entidad bancaria emisora de las mismas, si dicha entidad no autorizase el pago, Accuarium no será responsable por ningún retraso o falta de entrega y no podrá formalizar ningún contrato con el Usuario.
        <br/>
        Una vez que Accuarium reciba la orden de compra por parte del Usuario a través del Sitio Web, se hará una pre-autorización en la tarjeta que corresponda para asegurar que existen fondos suficientes para completar la transacción. El cargo en la tarjeta se hará en el momento en que se envíe al Usuario la confirmación de envío y/o confirmación del servicio que se presta en forma y, en su caso, lugar establecidos.
        <br/>
        Si el medio de pago es PayPal, el cargo se hará en el momento en que Accuarium envíe una confirmación del pedido de compra o adquisición de productos y/o servicios al Usuario.
        <br/>
        En todo caso, al hacer clic en "" el Usuario confirma que el método de pago utilizado es suyo.
        <br/>
        Los pedidos de compra o adquisición en los que el Usuario seleccione como medio de pago la transferencia bancaria serán reservados durante 5 días naturales a partir de la confirmación del pedido para poder dejar el tiempo suficiente a que la transferencia bancaria sea tomada en cuenta por el sistema de pagos utilizado por Accuarium para el Sitio Web. Cuando el sistema recibe la transferencia, el pedido será preparado y gestionado para envío.
        <br/>
        Mediante este método de pago, el Usuario debe asegurarse que introduce correctamente el importe exacto del pedido de compra, así como el número de cuenta y la referencia de la transferencia. En caso de error, Accuarium no podrá validar el pedido, que será anulado.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">6. ENTREGA</Typography>
      <Typography variant="body2">
        ...
        <br/>
        Si por algún motivo, que le fuera imputable, Accuarium no pudiera cumplir con la fecha de entrega, contactará al Usuario para informarle de esta circunstancia y, éste podrá elegir seguir adelante con la compra estableciendo una nueva fecha de entrega o bien anular el pedido con el reembolso total del precio pagado. En cualquier caso, las entregas a domicilio se realizan en días laborables.
        <br/>
        ...
        <br/>
        Los riesgos que de los productos se pudieran derivar serán a cargo del Usuario a partir del momento de su entrega. El Usuario adquiere la propiedad de los productos cuando Accuarium recibe el pago completo de todas las cantidades debidas en relación a la compra o adquisición efectuada, incluidos los gastos de envío, o bien en el momento de la entrega, si ésta tiene lugar en un momento posterior a la recepción completa del importe objeto de pago por Accuarium.
        <br/>
      ...
      <Typography variant="h6" component="h3">7. MEDIOS TÉCNICOS PARA CORREGIR ERRORES</Typography>
      <Typography variant="body2">
        Se pone en conocimiento del Usuario que en caso de que detecte que se ha producido un error al introducir datos necesarios para procesar su solicitud de compra en el Sitio Web, podrá modificar los mismos poniéndose en contacto con Accuarium a través de los espacios de contacto habilitados en el Sitio Web, y, en su caso, a través de aquellos habilitados para contactar con el servicio de atención al cliente, y/o utilizando los datos de contacto facilitados en la cláusula primera (Información general). Asimismo, estas informaciones también podrían subsanarse por el Usuario a través de su espacio personal de conexión al Sitio Web.
        <br/>
        En cualquier caso, el Usuario, antes de hacer clic en "", tiene acceso al espacio, carrito, o cesta donde se van anotando sus solicitudes de compra y puede hacer modificaciones.
        <br/>
      ...
      <Typography variant="h6" component="h3">8. DEVOLUCIONES</Typography>
      <Typography variant="body2">
        ...
        <Typography variant="subtitle1" component="h4">Derecho de Desistimiento</Typography>
        <Typography variant="body2">
        ...
        <br/>
        En caso de desistimiento, Accuarium reembolsará al Usuario todos los pagos recibidos, incluidos los gastos de envío (con la excepción de los gastos adicionales elegidos por el Usuario para una modalidad de envío diferente a la modalidad menos costosa ofrecida en el Sitio Web) sin ninguna demora indebida y, en todo caso, a más tardar en 14 días naturales a partir de la fecha en la que Accuarium es informado de la decisión de desistir por el Usuario.
        <br/>
        Accuarium reembolsará al Usuario utilizando el mismo método de pago que empleó este para realizar la transacción inicial de compra. Este reembolso no generará ningún coste adicional al Usuario. No obstante, Accuarium podría retener dicho reembolso hasta haber recibido los productos o artículos de la compra, o hasta que el Usuario presente una prueba de la devolución de los mismos, según qué condición se cumpla primero.
        <br/>
        El Usuario puede devolver o enviar los productos a Accuarium en: 
        <br/>
        Y deberá hacerlo sin ninguna demora indebida y, en cualquier caso, a más tardar en el plazo de 14 días naturales a partir de la fecha en que Accuarium fue informado de la decisión de desistimiento.
        <br/>
        ...
        <br/>
        En este mismo sentido se rige la prestación de un servicio que el Usuario pudiera contratar en este Sitio Web, pues esta misma Ley establece que no asistirá el Derecho de desistimiento a los Usuarios cuando la prestación del servicio ha sido completamente ejecutada, o cuando haya comenzado, con el consentimiento expreso del consumidor y usuario y con el reconocimiento por su parte de que es consciente de que, una vez que el contrato haya sido completamente ejecutado por Accuarium, habrá perdido su derecho de desistimiento.
        <br/>
        ...
        <br/>
        En el siguiente enlace puede descargarse el Modelo de formulario de desistimiento: http://accuarium.com/es/withdrawal
        </Typography><br/>
        <Typography variant="subtitle1" component="h4">Devolución de productos defectuosos o error en el envío</Typography>
        <Typography variant="body2">
        Se trata de todos aquellos casos en los que el Usuario considera que, en el momento de la entrega, el producto no se ajusta a lo estipulado en el contrato o pedido de compra, y que, por tanto, deberá ponerse en contacto con Accuarium inmediatamente y hacerle saber la disconformidad existente (defecto/error) por los mismos medios o utilizando los datos de contacto que se facilitan en el apartado anterior (Derecho de Desistimiento).
        <br/>
      ...
      <Typography variant="h6" component="h3">9. EXONERACIÓN DE RESPONSABILIDAD</Typography>
      <Typography variant="body2">
        Salvo disposición legal en sentido contrario, Accuarium no aceptará ninguna responsabilidad por las siguientes pérdidas, con independencia de su origen:
        <ul>
        ...
        <br/>
        Igualmente, Accuarium también limita su responsabilidad en cuanto a los siguientes casos:
        <ul>
          ...
          <li>Fallos técnicos que por causas fortuitas o de otra índole, impidan un normal funcionamiento del servicio a través de internet. Falta de disponibilidad del Sitio Web por razones de mantenimiento u otras, que impida disponer del servicio. Accuarium pone todos los medios a su alcance a efectos de llevar a cabo el proceso de compra, pago y envío/entrega de los productos, no obstante se exime de responsabilidad por causas que no le sean imputables, caso fortuito o fuerza mayor.
          <li>Accuarium no se hará responsable del mal uso y/o del desgaste de los productos que hayan sido utilizados por el Usuario. Al mismo tiempo, Accuarium tampoco se hará responsable de una devolución errónea realizada por el Usuario. Es responsabilidad del Usuario devolver el producto correcto.</li>
          <li>En general, Accuarium no se responsabilizará por ningún incumplimiento o retraso en el cumplimiento de alguna de las obligaciones asumidas, cuando el mismo se deba a acontecimientos que están fuera de su control razonable, es decir, que se deban a causa de fuerza mayor, y ésta podrá incluir, a modo enunciativo pero no exhaustivo:</li>
            <ul>
        ...
        De esta forma, las obligaciones quedarán suspendidas durante el periodo en que la causa de fuerza mayor continúe, y Accuarium dispondrá de una ampliación en el plazo para cumplirlas por un periodo de tiempo igual al que dure la causa de fuerza mayor. Accuarium pondrá todos los medios razonables para encontrar una solución que le permita cumplir con sus obligaciones a pesar de la causa de fuerza mayor.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">10. COMUNICACIONES POR ESCRITO Y NOTIFICACIONES</Typography>
      <Typography variant="body2">
        Mediante el uso de este Sitio Web, el Usuario acepta que la mayor parte de las comunicaciones con Accuarium sean electrónicas (correo electrónico o avisos publicados en el Sitio Web).
        <br/>
        A efectos contractuales, el Usuario consiente en usar este medio electrónico de comunicación y reconoce que todo contrato, notificación, información y demás comunicaciones que Accuarium envíe de forma electrónica cumplen con los requisitos legales de ser por escrito. Esta condición no afectará a los derechos reconocidos por ley al Usuario.
        <br/>
        El Usuario puede enviar notificaciones y/o comunicarse con Accuarium a través de los datos de contacto que en estas Condiciones se facilitan y, en su caso, a través de los espacios de contacto del Sitio Web.
        <br/>
        Igualmente, salvo que se estipule lo contrario, Accuarium puede contactar y/o notificar al Usuario en su correo electrónico o en la dirección postal facilitada.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">11. RENUNCIA</Typography>
      <Typography variant="body2">
        Ninguna renuncia de Accuarium a un derecho o acción legal concreta o la falta de requerimiento por Accuarium del cumplimiento estricto por el Usuario de alguna de sus obligaciones supondrá, ni una renuncia a otros derechos o acciones derivados de un contrato o de las Condiciones, ni exonerará al Usuario del cumplimiento de sus obligaciones.
        <br/>
        Ninguna renuncia de Accuarium a alguna de las presentes Condiciones o a los derechos o acciones derivados de un contrato surtirá efecto, a no ser que se establezca expresamente que es una renuncia y se formalice y se le comunique al Usuario por escrito.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">12. NULIDAD</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6" component="h3">13. ACUERDO COMPLETO</Typography>
      <Typography variant="body2">
        Las presentes Condiciones y todo documento al que se haga referencia expresa en estas constituyen el acuerdo íntegro existente entre el Usuario y Accuarium en relación con el objeto de compraventa y sustituyen a cualquier otro pacto, acuerdo o promesa anterior convenida verbalmente o por escrito por las mismas partes.
        <br/>
        El Usuario y Accuarium reconocen haber consentido la celebración de un contrato sin haber confiado en ninguna declaración o promesa hecha por la otra parte, salvo aquello que figura expresamente mencionado en las presentes Condiciones.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">14. PROTECCIÓN DE DATOS</Typography>
      <Typography variant="body2">
        La información o datos de carácter personal que el Usuario facilite a Accuarium en el curso de una transacción en el Sitio Web, serán tratados con arreglo a lo establecido en la Política de Privacidad o de protección de datos (contenida, en su caso, en el Aviso Legal y Condiciones Generales de Uso). Al acceder, navegar y/o usar el Sitio Web el Usuario consiente el tratamiento de dicha información y datos y declara que toda la información o datos que facilita son veraces.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">15. LEGISLACIÓN APLICABLE Y JURISDICCIÓN</Typography>
      <Typography variant="body2">
        ...
        <br/>
        Cualquier controversia, problema o desacuerdo que surja o este relacionado con el acceso, navegación y/o uso del Sitio Web, o con la interpretación y ejecución de estas Condiciones, o con los contratos de venta entre Accuarium y el Usuario, será sometida a la jurisdicción no exclusiva de los juzgados y tribunales españoles.
      </Typography>
      <br/>

      <Typography variant="h6" component="h3">16. QUEJAS Y RECLAMACIONES</Typography>
      <Typography variant="body2">
        El Usuario puede hacer llegar a Accuarium sus quejas, reclamaciones o todo otro comentario que desee realizar a través de los datos de contacto que se facilitan al principio de estas Condiciones (Información General).
        <br/>
        Además, Accuarium dispone de hojas oficiales de reclamación a disposición de los consumidores y usuarios, y que estos pueden solicitar a Accuarium en cualquier momento, utilizando los datos de contacto que se facilitan al principio de estas Condiciones (Información General).
        <br/>
        Asimismo, si de la celebración de este contrato de compra entre Accuarium y el Usuario emanara una controversia, el Usuario como consumidor puede solicitar una solución extrajudicial de controversias, de acuerdo con el Reglamento (UE) 524/2013 del Parlamento Europeo y del Consejo, de 21 de mayo de 2013, sobre resolución de litigios en línea en materia de consumo y por el que se modifica el Reglamento (CE) 2006/2004 y la Directiva 2009/22/CE. Puede acceder a este método a través del siguiente sitio web: https://ec.europa.eu/consumers/odr/.
        <br/>
