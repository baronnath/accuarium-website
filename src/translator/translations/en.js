const en = {
  ...
  home: {
    section1: {
      ...
      grid: {
        1: {
          title: 'Improve the survival rate',
          alt: 'Improve the fishes and all your species in your aquarium survival rate',
        },
        2: {
          title: 'Verified by a zoologist',
          alt: 'All data in the app has been verified by a zoologist',
        },
        3: {
          title: 'Build a balanced ecosystem',
          alt: 'Build a balanced ecosystem in your aquarium where your fishes can be happy',
        },
      }
    },
    section2: {
      title: {
        line1: 'Find and compare',
        line2: 'new compatible species',
      },
    },
    section3: {
      title: {
        line1: 'Find out how to',
        line2: 'improve your accuarium',
      },
      subtitle: 'Figure out potential problems and risks',
    },
    section4: {
      title: {
  ...
  subscribe: {
    ...
    email: {
      label: 'Email',
      helper: 'Required to access to the app',
    },
    submit: 'Subscribe',
    description: 'After early access release you will get an email address providing your credentials and the link to get the app installed in your phone. Your email address will only be used to send you Accuarium last news and issue your credentials.',
    success: 'Thank you! You\'ve signed up successfully',
    policy: {
      label: 'I have read and accept the privacy policy and the terms and conditions',
    },
  },
  validation: {
    email: {
    ...
    policy: {
      notAccepted: 'Please read and accept the policies',
    },
  },
  legal: {
