const es = {
  ...
  home: {
    ...
    section4: {
      title: {
        line1: 'Comprueba la compatibilidad',
        line2: 'entre las especies',
      },
      subtitle: 'Anticípate a cualquier problema',
    },
    section5: {
      title: {
  ...
  faq: {
    ...
    questions: {
      1: {
        ...
        answer: 'No importa si estás planeando un nuevo proyecto o si estás intentando descubrir qué es lo que no funciona en tu acuario ya montado, accuarium es tu mejor compañero en el mundo de los acuarios. Anticípate a los problemas y consigue un acuario equilibrado, accuarium te ofrece la información que necesitas para que tus peces vivan más felices. Averigua los parámetros correctos, la alimentación y el comportamiento de las especies que elegiste y enceuntra los compañeros de acuario perfectos evitando errores fatales. Reduce al mínimo el índice de mortalidad. accuarium es súper fácil e intuitiva de usar, verás qué divertido.',
      },
      2: {
      ...
      4: {
        ...
        answer: 'No, accuarium no ofrece este tipo de servicio. Pero igualmente queremos recordarte que al comprar peces o plantas, es importante considerar factores como la salud de los animales, la procedencia ética y la compatibilidad con las especies existentes en tu acuario.',
      },
      5: {
  ...
  reports: {
    sitemap: 'Sitemap',
    success: 'El informe se ha descargado correctamente',
  },
  thankYou: {
